    ...
    public class AcidShooter : CustomWeapon, ICustomItemGlow
    {
        ...
        protected override void OnShot(ShotEventArgs ev)
        {
            if (Check(ev.Player.CurrentItem))
            {
                ev.CanHurt = false;
                float intensity = 50f;
                Color baseColor = new Color32(128, 255, 0, 121);
                ...
                SpawnPrimitive.spawnPrimitivesNoGravity(ev.Player, 13, rotation, laserPos, glowColor,4,55, typeof(PoisonBulletCollision));
            }
            base.OnShot(ev);
        }
        ...
        public Color CustomItemGlowColor { get; set; } = new Color(0.5f, 1.0f, 0.0f, 0.1f);
