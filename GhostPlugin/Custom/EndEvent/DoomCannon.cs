...
namespace GhostPlugin.Custom.EndEvent
{
    ...
    public class DoomCannon : CustomWeapon
    {
        public override uint Id { get; set; } = 666;
        public override string Name { get; set; } = "Doom Cannon";
        public override string Description { get; set; } = "사정거리가 넓은 로캣포입니다!\n(폭탄이 포물선이 아닌 직진으로 갑니다)";
        ...
        private const int MaxCharges = 225;
        ...
        protected override void OnReloading(ReloadingWeaponEventArgs ev)
        {
            ...
            ev.Player.EnableEffect<Scp1853>(intensity: 6, duration: 3);
            ev.IsAllowed = true;
        }
